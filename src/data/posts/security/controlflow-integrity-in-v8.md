...
Published 09 October 2023 · Tagged with [security](/blog/tags/security)
...
Forward-Edge CFI [#](#forward-edge-cfi)
=======================================
...
Backward-Edge CFI [#](#backward-edge-cfi)
=========================================
...
Pointer Authentication (PAC-RET) [#](#pointer-authentication-\(pac-ret\))
-------------------------------------------------------------------------
...
JIT Memory Integrity [#](#jit-memory-integrity)
===============================================
...
Per-thread Memory Permissions [#](#per-thread-memory-permissions)
-----------------------------------------------------------------
...
Corrupted Syscall Arguments [#](#corrupted-syscall-arguments)
-------------------------------------------------------------
...
Signal Frame Corruption [#](#signal-frame-corruption)
-----------------------------------------------------
