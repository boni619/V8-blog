...
Published 05 December 2023 · Tagged with [JavaScript](/blog/tags/javascript)
...
Maglev: A Simple SSA-Based JIT compiler [#](#maglev%3A-a-simple-ssa-based-jit-compiler)
=======================================================================================
...
Known Node Information [#](#known-node-information)
---------------------------------------------------
...
![](/_img/maglev/compile-time.svg)

Compile time comparison of the compilation tiers, for all functions compiled in JetStream
...
![](/_img/maglev/I-IS-IT-IST-ISTM.svg)
