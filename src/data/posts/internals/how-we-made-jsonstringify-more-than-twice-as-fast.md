...
Published 04 August 2025 · Tagged with [internals](/blog/tags/internals)
...
A Side-Effect-Free Fast Path [#](#a-side-effect-free-fast-path)
===============================================================
...
Optimizing String Serialization with SIMD [#](#optimizing-string-serialization-with-simd)
=========================================================================================
...
The Express Lane on the Fast Path [#](#the-express-lane-on-the-fast-path)
=========================================================================
...
A faster double-to-string algorithm [#](#a-faster-double-to-string-algorithm)
=============================================================================
...
Optimizing the underlying temporary buffer [#](#optimizing-the-underlying-temporary-buffer)
===========================================================================================
