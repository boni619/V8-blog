...
Published 14 August 2018 · Tagged with [internals](/blog/tags/internals)
...
![](/_img/embedded-builtins/snapshot-size.png)
...
Embedded builtins [#](#embedded-builtins)
-----------------------------------------
...
### Isolate- and process-independent code [#](#isolate--and-process-independent-code)
...
![](/_img/embedded-builtins/pc-relative-call.png)
...
![](/_img/embedded-builtins/isolate-layout.png)
...
Sharing across processes [#](#sharing-across-processes)
-------------------------------------------------------
...
![](/_img/embedded-builtins/binary-format.png)
...
![](/_img/embedded-builtins/build-process.png)
...
![](/_img/embedded-builtins/code-on-heap.png)
...
![](/_img/embedded-builtins/code-off-heap.png)
...
![](/_img/embedded-builtins/isolate-layout-optimized.png)
...
![](/_img/embedded-builtins/results.png)
