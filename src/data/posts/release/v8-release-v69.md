...
Published 07 August 2018 · Tagged with [release](/blog/tags/release)
...
Memory savings through embedded built-ins [#](#memory-savings-through-embedded-built-ins)
-----------------------------------------------------------------------------------------
...
### Liftoff, WebAssembly’s new first-tier compiler [#](#liftoff%2C-webassembly%E2%80%99s-new-first-tier-compiler)
...
Logo for Liftoff, V8’s baseline compiler for WebAssembly

### Faster `DataView` operations [#](#faster-dataview-operations)
...
### Faster processing of `WeakMap`s during garbage collection [#](#faster-processing-of-weakmaps-during-garbage-collection)
