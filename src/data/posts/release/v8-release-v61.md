...
Published 03 August 2017 · Tagged with [release](/blog/tags/release)
...
Binary size reduction [#](#binary-size-reduction)
-------------------------------------------------
...
asm.js is now validated and compiled to WebAssembly [#](#asm.js-is-now-validated-and-compiled-to-webassembly)
-------------------------------------------------------------------------------------------------------------
