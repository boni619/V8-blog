...
Published 06 February 2017 · Tagged with [release](/blog/tags/release)
...
### Native async functions as fast as promises [#](#native-async-functions-as-fast-as-promises)
...
![](/_img/v8-release-57/async.png)

Async performance improvements in V8 on Linux x64

### Continued ES2015 improvements [#](#continued-es2015-improvements)
...
### RegExp 15% faster [#](#regexp-15%25-faster)
...
WebAssembly enabled [#](#webassembly-enabled)
---------------------------------------------
...
V8 API additions [#](#v8-api-additions)
---------------------------------------
