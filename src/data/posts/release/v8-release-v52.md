...
Published 04 June 2016 · Tagged with [release](/blog/tags/release)
...
ES2015 & ES2016 support [#](#es2015-%26-es2016-support)
-------------------------------------------------------
...
This release contains support for the ES2016 exponentiation operator, an infix notation to replace `Math.pow`.
    ...
    let n = 3**3; // n == 27n **= 2; // n == 729

### Evolving spec [#](#evolving-spec)
