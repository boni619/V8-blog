...
Published 20 November 2019 · Tagged with [release](/blog/tags/release)
...
### Removed deprecation for Double ⇒ Tagged transitions [#](#removed-deprecation-for-double-%E2%87%92-tagged-transitions)
...
![](/_img/v8-release-79/speedometer-angularjs.svg)

Speedometer AngularJS score improvements

### Handle API getters in builtins [#](#handle-api-getters-in-builtins)
...
![](/_img/v8-release-79/speedometer.svg)

Speedometer Backbone and jQuery improvements

### OSR caching [#](#osr-caching)
...
![](/_img/v8-release-79/osr-caching.svg)

OSR caching improvements

WebAssembly [#](#webassembly)
-----------------------------

### Support for multiple code spaces [#](#support-for-multiple-code-spaces)
