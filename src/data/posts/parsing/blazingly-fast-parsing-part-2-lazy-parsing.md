...
Published 15 April 2019 · Tagged with [internals](/blog/tags/internals) [parsing](/blog/tags/parsing)
...
Teaching the preparser about variables [#](#teaching-the-preparser-about-variables)
-----------------------------------------------------------------------------------
...
Skipping inner functions [#](#skipping-inner-functions)
-------------------------------------------------------
...
![](/_img/preparser/parse-complexity-before.svg)
...
![](/_img/preparser/parse-complexity-after.svg)
...
![](/_img/preparser/skipping-inner-functions.svg)
...
![](/_img/preparser/eager-parse-compile-pife.svg)
...
![](/_img/preparser/eager-compilation-overhead.svg)
