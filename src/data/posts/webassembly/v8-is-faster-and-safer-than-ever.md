...
Published 14 December 2023 · Tagged with [JavaScript](/blog/tags/javascript) [WebAssembly](/blog/tags/webassembly) [security](/blog/tags/security) [benchmarks](/blog/tags/benchmarks)
...
Maglev: new mid tier optimizing compiler [#](#maglev%3A-new-mid-tier-optimizing-compiler)
=========================================================================================
...
Turboshaft: new architecture for the top-tier optimizing compiler [#](#turboshaft%3A-new-architecture-for-the-top-tier-optimizing-compiler)
===========================================================================================================================================
...
Faster HTML parser [#](#faster-html-parser)
===========================================
...
Faster DOM allocations [#](#faster-dom-allocations)
===================================================
...
New JavaScript features [#](#new-javascript-features)
=====================================================
...
WebAssembly updates [#](#webassembly-updates)
=============================================
...
WebAssembly Garbage Collection [#](#webassembly-garbage-collection)
===================================================================
...
![](/_img/holiday-season-2023/scores.svg)

Web performance benchmarks measured on a 13” M1 MacBook Pro.
