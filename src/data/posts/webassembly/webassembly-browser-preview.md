...
Published 31 October 2016 · Tagged with [WebAssembly](/blog/tags/webassembly)
...
What does this milestone mark? [#](#what-does-this-milestone-mark%3F)
---------------------------------------------------------------------
...
![](/_img/webassembly-browser-preview/gcd.svg)

An implementation of the Greatest Common Divisor function in WebAssembly, showing the raw bytes, the text format (WAST), and the C source code.
